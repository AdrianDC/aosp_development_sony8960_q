...
int init_wifi_nan_hal_func_table_mock(wifi_hal_fn *hal_fn) {
  ...
  hal_fn->wifi_nan_data_interface_create = wifi_nan_data_interface_create_mock;
  hal_fn->wifi_nan_data_interface_delete = wifi_nan_data_interface_delete_mock;
  hal_fn->wifi_nan_data_request_initiator = wifi_nan_data_request_initiator_mock;
  hal_fn->wifi_nan_data_indication_response = wifi_nan_data_indication_response_mock;
  hal_fn->wifi_nan_data_end = wifi_nan_data_end_mock;
