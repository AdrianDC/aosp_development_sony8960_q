...
public class WifiVendorHal {
    ...
    /**
     * Chatty logging should use mLog
     */
    @VisibleForTesting
    WifiLog mLog = sNoLog;

    /**
     * Errors should use mErrLog
     */
    @VisibleForTesting
    WifiLog mErrLog = new LogcatLog("WifiVendorHal");
     ...
     *
     * Failures are logged to mErrLog.
     *
    ...
    private WifiLog.LogMessage enter(String format) {
        if (mLog == sNoLog) return sNoLog.info(format);
        Thread cur = Thread.currentThread();
        StackTraceElement[] trace = cur.getStackTrace();
    ...
    private void handleRemoteException(RemoteException e) {
        mErrLog.e("RemoteException in HIDL call " + e);
    }

    private void noteHidlError(WifiStatus status, String culprit) {
        mErrLog.e("Error in " + culprit + " code: " + status.code
                + " (" + status.description + ")");
    }
        ...
        synchronized (sLock) {
            ...
            try {
                ...
                if (ok(status)) {
                    ...
                    mLog.d("enabling rtt " + mRttResponderCmdId);
                } else {
            ...
            try {
                ...
                if (config.whitelistSsids != null) {
                    for (String ssidStr : config.whitelistSsids) {
                        ...
                        if (len > 32) {
                            mErrLog.err("configureRoaming: skip invalid SSID %")
    ...
    public class HalDeviceManagerStatusListener implements HalDeviceManager.ManagerStatusListener {
        ...
        public void onStatusChanged() {
            ...
            mLog.i("Device Manager onStatusChanged. isReady(): " + isReady
                    + ", isStarted(): " + isStarted);
